    ...
    get houseCard(){
        ...
        <div class='col-md-3'>
            <div class='shadow'>
                ...
                <p id='house-description' class='fw-bold p-2 text-wrap'>Description: ${this.description}</p>
    ...
    if (AppState.account != null && AppState.account.id == this.creatorId) {
        ...
        <div id='house-form-${this.id}' class='d-none'>
            <form class="mt-2 mb-2" onsubmit="app.HouseController.updateHouse('${this.id}'); return false;">
                ...
                <textarea type="text" name="description" placeholder="Description" class="form-control my-1">${this.description}</textarea>
